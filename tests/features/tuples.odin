...
add_vector_and_point :: proc(t: ^testing.T) {
	...
	testing.expect(t, result == [4]f64{1, 1, 6, 1}, "addition was not correct")
}
...
subtract_point_and_point :: proc(t: ^testing.T) {
	...
	testing.expect(t, result == [4]f64{-2, -4, -6, 0}, "subtraction was not correct")
}
...
subtract_vector_and_point :: proc(t: ^testing.T) {
	...
	testing.expect(t, result == [4]f64{-2, -4, -6, 1}, "subtraction was not correct")
}
...
normalize_vector :: proc(t: ^testing.T) {
	...
	v1 = tuples.vector(1, 2, 3)
	expected = tuples.vector(1 / math.sqrt_f64(14), 2 / math.sqrt_f64(14), 3 / math.sqrt_f64(14))
	norm = tuples.normalize(v1)
